...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex justify-center overflow-auto px-4 py-8">
        <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-xl mt-25" data-aos="fade-up" data-aos-duration="1000">
            ...
            <form action="<?= url_to('login') ?>" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" required class="form-input" placeholder="<?= lang('Auth.email') ?>"
                        oninvalid="this.setCustomValidity('Silakan isi alamat email.')"
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required class="form-input" placeholder="<?= lang('Auth.password') ?>"
                        oninvalid="this.setCustomValidity('Silakan isi kata sandi.')"
                        oninput="this.setCustomValidity('')">
                </div>
                ...
                <div>
                    ...
                    <div class="flex justify-center gap-4 flex-wrap">
                        <!-- Google -->
                        <a href="<?= base_url('oauth/google') ?>" class="flex items-center gap-2 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg shadow hover:bg-gray-100 transition">
                            <i class="bi bi-google text-blue-500 text-lg"></i>
                            <span class="text-sm font-medium">Google</span>
                        </a>
                        <!-- GitHub -->
                        <a href="<?= base_url('oauth/github') ?>" class="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg shadow hover:bg-gray-800 transition">
                            <i class="bi bi-github text-lg"></i>
                            <span class="text-sm font-medium">GitHub</span>
                        </a>
                        <!-- Facebook -->
                        <a href="<?= base_url('oauth/facebook') ?>" class="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition">

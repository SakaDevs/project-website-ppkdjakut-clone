    ...
    <div class="container mx-auto px-4 py-8 mt-20" data-aos="fade-up" data-aos-duration="1000">
            <div class="max-w-9xl mx-auto">
                <div class="text-center mb-12">
                    <h1 class="text-3xl text-gray-800 font-light mb-4">List Pelatihan Regular</h1>
                    
                    <form class="max-w-md mx-auto mb-10" method="get" action="<?= base_url('pelatihan/regular/search') ?>">   
                        ...
                        <?php if(auth()->loggedIn() && auth()->user()->inGroup('admin')):?>
                            <div class="text-center mt-6">
                                <a href="<?= base_url('pelatihan/regular/tambah') ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">
            ...
            <?php foreach ($pelatihan as $row): ?>
                    <div class="job-card bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100 hover:border-indigo-200 flex flex-col">
                        ...
                        <div class="card-content p-6 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto">
                                <a href="/pelatihan/regular/daftar" 
                                ...
                                <?php if(auth()->loggedIn() && auth()->user()->inGroup('admin')):?>
                                    <div class="flex items-center gap-5 justify-center mt-4">
                                        <a href="/pelatihan/regular/edit/<?= $row['id']?>" class="bg-green-600 hover:bg-green-700 text-white text-center rounded px-4 py-2 text-sm">
                                            Edit
                                        </a>
                                        <form action="/pelatihan/regular/delete/<?= $row['id'] ?>" method="post" onsubmit="return confirm('Apakah kamu yakin ingin menghapus lowongan ini?');">
                                            <?= csrf_field() ?>

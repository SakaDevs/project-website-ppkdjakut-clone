...
<?= view('layout/navbar') ?>
    <section class="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
        ...
        <aside class="md:col-span-1">
            ...
            <!-- SKKNI Box -->
            <div class="mt-6 border p-4 rounded-lg bg-gray-50 shadow-sm">
        ...
        <div class="md:col-span-2 space-y-6">
            <img src="https://ppkdju.com/static/img/regular/1024x648/inggris.jpg" alt="Pelatihan Bahasa Inggris" class="rounded-md shadow-md w-full max-h-[500px] object-cover">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                    Melakukan perkenalan / Introductions
                </h2>
                <p class="text-gray-700 text-sm">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                Menggunakan ungkapan umum dalam bertelepon
                </h2>
                <p class="text-gray-700 text-sm">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-800 flex items-center gap-2">
                <span class="text-green-600">●</span> Menerima dan menyampaikan pesan telepon
                </h2>
                <p class="text-gray-700 text-sm">
            ...
            <!-- Tambahkan bagian lain seperti “Menyiapkan Presentasi”, dll. sesuai kebutuhan -->
            </div>
        </div>
    </section>

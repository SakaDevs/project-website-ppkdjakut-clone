...
<?= view('layout/navbar') ?>
    ...
    <div class="md:col-span-2 space-y-6">
        <img src="https://ppkdju.com/static/img/regular/1024x648/listrik.jpg" alt="Pelatihan Listrik Industri" class="rounded-md shadow-md w-full max-h-[500px] object-cover">

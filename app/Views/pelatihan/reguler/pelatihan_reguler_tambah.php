    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-xl border border-gray-100 justify-center mt-20" data-aos="fade-up" duration="3000">
        ...
        <form action="<?= base_url('pelatihan/regular/add') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="jenis_pelatihan" class="w-full p-3 border border-gray-300 rounded-xl" value="<?= old('nama_pelatihan') ?>" required>
            </div>
            
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Total Hari</label>
                <input type="number" max="45" min="1" name="total_hari" class="w-full p-3 border border-gray-300 rounded-xl" value="<?= old('nama_pelatihan') ?>" required>
            </div>

            <div class="mb-4">
                <label class="block font-medium text-gray-700">Total Peserta</label>
                <input type="number" max="20" min="1" name="total_peserta" class="w-full p-3 border border-gray-300 rounded-xl" value="<?= old('nama_pelatihan') ?>" required>
            </div>
            
            <div class="mb-4">
                <label class="block font-medium text-gray-700">Total Peserta</label>
                <input type="date" name="pembukaan" class="w-full p-3 border border-gray-300 rounded-xl" value="<?= old('nama_pelatihan') ?>" required>
            </div>

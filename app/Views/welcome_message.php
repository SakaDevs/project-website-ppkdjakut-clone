...
<body x-data="{ isVideoModalOpen: false }" @keydown.escape.window="isVideoModalOpen: false">
    ...
    <div class="hero flex min-h-screen flex-col items-center justify-center px-4 text-center sm:mt-0">
        ...
        <h1 class="mt-8 text-3xl font-light sm:text-4xl mdx:text-cyan-400" data-aos="fade-up" data-aos-delay="200">Selamat datang <span class="text-cyan-600 font-light"><?= auth()->user()->username ?? 'Jaknaker' ?></span></h1>
